...
def main():
    information = dict(name=None, year=datetime.datetime.today().year,
...
def populate_information(information):
    ...
    year = get_integer('Enter copyright year', 'year', information['year'], 2000,
                       datetime.datetime.today().year + 1, True)
    if year == 0:
        ...
        try:
            ...
            if not line:
                ...
                if minimum_length == 0:
                    ...
                    raise ValueError('{0} may notbe empty'.format(name))
